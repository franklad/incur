...
export type Handler<vars extends z.ZodObject<any> | undefined = undefined> = (
  context: Context<vars>,
  next: () => Promise<void>,
) => Promise<void> | void

/** Context available inside middleware. */
export type Context<vars extends z.ZodObject<any> | undefined = undefined> = {
...
/** Creates a strictly typed middleware handler. Pass the vars schema as a generic for typed `c.set()` and `c.var`. */
export default function middleware<const vars extends z.ZodObject<any> | undefined = undefined>(
